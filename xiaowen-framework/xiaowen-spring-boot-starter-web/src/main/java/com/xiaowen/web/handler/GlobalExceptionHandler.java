package com.xiaowen.web.handler;
...
import com.xiaowen.common.util.collection.SetUtils;
import com.xiaowen.common.util.json.JsonUtils;
import com.xiaowen.common.util.monitor.TracerUtils;
import com.xiaowen.common.util.servlet.ServletUtils;
import com.xiaowen.web.util.WebFrameworkUtils;
import com.xiaowen.infra.api.logger.ApiErrorLogApi;
import com.xiaowen.infra.api.logger.dto.ApiErrorLogCreateReqDTO;
...
import static com.xiaowen.common.exception.enums.GlobalErrorCodeConstants.*;
...
//    }
    ...
    private void buildExceptionLog(ApiErrorLogCreateReqDTO errorLog, HttpServletRequest request, Throwable e) throws IOException {
        // 处理用户信息
